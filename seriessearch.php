...
<head>
    ...
    <link rel="stylesheet" href="seriessearch.css">
...
<body>
    ...
    <?php
        ...
        $name=$_POST["msearch"];
        $sql="SELECT * FROM series where parent like '%$name%' or name like '%$name%'";
        if($conn->query($sql))
        {
            ...
            if($result->num_rows>0)
            {
                while($row=$result->fetch_assoc())
                {
                    ...
                    echo "<div><form method='POST' action='seriesdata.php'>";
